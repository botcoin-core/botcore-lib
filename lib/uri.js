 ...
 * ```javascript
 *
 * var uri = new URI('botcoin:XsV4GHVKGTjQFvwB7c6mYsGV3Mxf7iser6?amount=1.2');
 ...
 * ```javascript
 *
 * var valid = URI.isValid('botcoin:XsV4GHVKGTjQFvwB7c6mYsGV3Mxf7iser6');
 * // true
 * ```
 *
 * @param {string|Object} data - A bitcoin URI string or an Object
...
URI.parse = function(uri) {
  ...
  if (info.protocol !== 'botcoin:') {
    throw new TypeError('Invalid botcoin URI');
  }
...
URI.prototype._fromObject = function(obj) {
  ...
  if (!Address.isValid(obj.address)) {
    throw new TypeError('Invalid botcoin address');
  }
