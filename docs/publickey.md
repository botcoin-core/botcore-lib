# Public Key
Represents a Botcoin public key and is needed to be able to receive funds, as is usually represented as a Botcoin [Address](address.md). See the official [Bitcoin Wiki](https://en.bitcoin.it/wiki/Technical_background_of_version_1_Bitcoin_addresses).
...
> var compressedPK2 = new botcore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = botcore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
