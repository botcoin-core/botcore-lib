...
For detailed technical information about a block please visit [Blocks](https://botcoin-docs.github.io/en/glossary/block) on the Botcoin Wiki.
...
For more information about the specific properties of a block header please visit the [Block headers](https://botcoin-docs.github.io/en/developer-reference#block-headers) page on the Botcoin Developer Reference Wiki.
