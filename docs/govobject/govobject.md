...
# Governance Object
A Governance Object (or "govObject") is a generic structure introduced in Botcoin Core v12.1 to allow for the creation of Budget Proposals, Triggers, and Watch Dogs. Class inheritance has been utilized to extend this generic object into a "Proposal" which is outlined throughout the remainder of this document. 
...
var jsonProposal = {
  ...
  url:"http://www.botcoin.co/proposal/first_proposal"
};
...
```javascript
proposal.url="http://botcoin.co/badUrl"
var shallowCopyProposal = proposal.shallowCopy();
proposal.url="http://botcoin.co/fixedUrl"
